...
public class NextpeerGameManager : MonoBehaviour
{
...
#elif UNITY_ANDROID
		Nextpeer.Init ("6ad089034ab1058a452ce84224ee9465", Settings);
#endif
    ...
    IEnumerator ShowPlayePortrait(String ImageURL, String PlayerName, String message)
    {
        ...
        imgtxtr.GetComponent<GUITexture>().pixelInset = new Rect(10, 0, image.texture.width*scale, image.texture.height*scale);
        Txt.GetComponent<GUIText>().pixelOffset = new Vector2(10, image.texture.height * scale + 65);
