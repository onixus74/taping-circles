...
namespace Soomla.Store.IAP                                                                                                                 //Allows for access to Soomla API
{
    public class IAPAssets : IStoreAssets
    {
        ...
        {                                                                                               // Add "TURN_GREEN" IAP to GetGoods
            return new VirtualGood[] { REMOVE_ADS,REMOVE_ADSM, REVEAL_FROGS, RESET_LEVEL };
        }
        ...
        public static VirtualGood REMOVE_ADSM = new LifetimeVG(
            "remove_ads",                         // Name of IAP
            "This will remove the ads",     // Description of IAP
            "remove_adsm_item_id",                 // Item ID (different from 'product id" used by itunes, this is used by soomla                                             3.
            new PurchaseWithMarket(REMOVE_ADS_ITEM_ID, 1.99));
